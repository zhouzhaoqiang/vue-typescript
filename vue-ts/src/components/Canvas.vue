<template>
  <div id="main">
    <div id="main-canvas">
      <canvas id="main-canvas-bg"></canvas>
    </div>
  </div>
</template>
​
...
​
  mounted(){
    const bg = document.getElementById('main-canvas-bg') as HTMLCanvasElement,
          bgMain = document.getElementById('main-canvas') as HTMLDivElement
